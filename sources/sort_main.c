...
/*   Updated: 2020/03/06 16:54:57 by fprovolo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ft_max(shift.a, shift.b) <= \
			ft_max(stk->len_a - shift.a, stk->len_b - shift.b) && \
			ft_max(shift.a, shift.b) <= \
			ft_min(stk->len_a - shift.a + shift.b, shift.a + stk->len_b - \
			shift.b))
