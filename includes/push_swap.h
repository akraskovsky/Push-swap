...
/*   Updated: 2020/03/06 17:09:03 by fprovolo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define COL_CTA		0xFFFFAA
# define COL_BARS		0x038C66
# define COL_NG_BARS	0x883333
...
size_t					calc_commands(t_stk *stk, size_t shift_a, \
							size_t shift_b);
...
void					draw_line(t_stk *stk, int start_x, int start_y, \
							int len);
